...
public class Main {
  ...
  // AnnotationConfigApplicationContext(TicketsContextConfiguration.class);
  //
  ...
  ////        Ticket fullTicket = new Ticket("NARODOWY", 948, Instant.parse("2025-06-23T00:00:00Z"),
  // true, StadiumSector.B, 21, new BigDecimal("123.99"));
  //
