...
public class TicketDAO {
  ...
  private static final String SELECT_ALL_TICKETS_BY_USER_ID_QUERY =
      "SELECT * FROM tickets WHERE user_id = ?";
  private static final String INSERT_TICKET_QUERY =
      "INSERT INTO tickets (id, user_id, ticket_type, creation_time) VALUES (?, ?, ?::ticket_type, ?)";
  private static final String UPDATE_TICKET_TYPE_QUERY =
      "UPDATE tickets SET ticket_type = ?::ticket_type WHERE id = ?";
